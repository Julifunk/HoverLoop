...
public class OVRPlayerController : MonoBehaviour
{
	...
	/// <summary>
	/// When true, user inpqqqut will be applied to rotation. Set this to false whenever the player controller needs to ignore input for rotation.
	/// </summary>
